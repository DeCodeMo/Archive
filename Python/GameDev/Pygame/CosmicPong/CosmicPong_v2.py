...
from settings import BALL_COLOR, CPU_SPEED
...
def animate_ball(ball):
    ...
    global ball_speedx, ball_speedy, PAD1_SCORE, PAD2_SCORE, BALL_SPEED
...
def draw_ball(surface, color, ball):
    ...
    called in game loop
    '''
    pg.draw.ellipse(surface, color, ball)
...
ball_speedy = BALL_SPEED * rand.choice((1, -1))
